...
// Build the final normalised list:
// 1. Keep everything that isn't a size-variant category (goat / fish / chicken).
// 2. For size-variant categories, use weightVariants as the sole source of truth —
//    one card per dish, all sizes shown together under one image.
